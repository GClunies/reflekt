...
# Reflekt
Reflekt automagically models and documents the events in your tracking plan pulled from your Analytics Governance tool, and bundles them in a dbt package ready for use in your dbt project. Each Reflekt dbt package includes:
