...
class SegmentPlan(object):
    ...
    def _build_reflekt_plan_file(self, plan_dir):
        ...
        plan_obj = {"name": self.display_name}  # Segment refers to the plan name as the `display_name` in their API
    ...
    def _build_reflekt_identify_file(self, plan_dir, traits_json):
        traits = [parse_segment_property(name, prop_json) for (name, prop_json) in traits_json.items()]
    ...
    def _build_reflekt_group_file(self, plan_dir, group_traits_json):
        traits = [parse_segment_property(name, prop_json) for (name, prop_json) in group_traits_json.items()]
