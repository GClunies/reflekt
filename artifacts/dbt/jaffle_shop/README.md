# jaffle_shop
A private dbt package built by [Reflekt](https://github.com/GClunies/reflekt) defining sources, models, and documentation based on events schemas defined in Reflekt project `jaffle_shop`.
...
packages:
  - git: "https://github.com/<your_user_or_org>/<your_repo>"  # Replace with Github repo URL for your Reflekt project
    ...
    revision: v0.1.0__jaffle_shop  # Example tag. Replace with branch, tag, or commit (full 40-character hash)
```
